...
export function ProfileSidebar({ className }: ProfileSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'border-gray-150 bg-gray-0 w-full rounded-2xl border px-6 py-6 shadow-(--shadow-02) md:px-7 md:py-8 lg:min-h-[915px] lg:w-[27%] lg:min-w-[300px] lg:shrink-0 lg:px-7 lg:py-12',
        className,
      )}
    >
      {isEditing ? (
