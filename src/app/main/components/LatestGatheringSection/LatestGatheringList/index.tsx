...
export function LatestGatheringList() {
  ...
  const { page, setPage, totalPages, visibleGatherings, isPending } = useLatestGatherings();
      ...
      <div className='mb-4 flex items-center justify-between'>
        ...
        {!isEmpty && (
          <div className='flex items-center gap-3 md:gap-6'>
            <Link href='/gatherings' className='text-small-02-m md:text-small-01-m lg:text-body-02-m text-gray-600'>
              더보기
            </Link>
