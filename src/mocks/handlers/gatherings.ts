...
const mockDetails: Record<number, GatheringDetail> = {
  1: {
    ...
    totalWeeks: 8,
    images: [
      { url: 'https://placehold.co/800x500?text=React+Study+1', displayOrder: 0 },
      { url: 'https://placehold.co/800x500?text=React+Study+2', displayOrder: 1 },
      { url: 'https://placehold.co/800x500?text=React+Study+3', displayOrder: 2 },
    ],
    weeklyPlans: [
