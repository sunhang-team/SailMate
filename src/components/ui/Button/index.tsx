...
export const buttonVariants = cva('cursor-pointer transition-colors disabled:cursor-not-allowed', {
  variants: {
    variant: {
      ...
      'add-detail': 'rounded-lg flex items-center justify-center gap-1  md:text-body-02-r text-gray-600 bg-gray-100',
    ...
    size: {
      ...
      participation: 'h-13.5 md:h-18 w-[447px]',
      ...
      'bookmark-lg': 'md:h-18 md:w-18 [border-width:1.64px] h-13.5 w-13.5',
      'social-icon': 'lg:h-10 lg:w-12 md:h-8 md:w-11 w-9 h-7',
