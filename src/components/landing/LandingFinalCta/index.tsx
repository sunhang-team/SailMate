  ...
  return (
    <section className='relative overflow-hidden py-16 md:py-20 lg:py-24'>
      <div className='pointer-events-none absolute inset-0' aria-hidden>
        <Image src={LANDING_IMAGES.bottomImagePC} alt='' fill className='hidden object-cover lg:block' sizes='100vw' />
        <Image
          src={LANDING_IMAGES.bottomImageTablet}
          alt=''
          fill
        ...
        />
        <Image
          src={LANDING_IMAGES.bottomImageMobile}
          alt=''
          fill
      ...
      <div className='relative mx-auto flex w-full max-w-[720px] flex-col items-center px-6 text-center'>
        <p className='text-body-01-b lg:text-h4-b md:text-h5-b text-blue-500'>더 나은 완성도를 위한 가장 확실한 선택</p>
        <h2 className='text-small-01-b lg:text-h2-b md:text-h3-b max-md:text-h4-b mt-3 mb-7 text-blue-500'>
